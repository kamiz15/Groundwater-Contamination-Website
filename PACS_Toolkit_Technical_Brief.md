# PACS Toolkit — Technical Reference
...
- Runtime guards: minimum grid spacing of 0.1 m, optional per-process solver timeout, time-step count derived from a Courant criterion, and Péclet/Courant values reported with the result.
