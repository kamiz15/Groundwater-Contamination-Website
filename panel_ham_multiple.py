...
def ham_multiple_app():
    ...
    table = pn.widgets.Tabulator(init_df, titles=table_titles(init_df.columns), height=300, sizing_mode="stretch_width", name="Ham scenarios")
    ...
    def _run(_=None):
        try:
            ...
            _state.update({
                ...
                "plot_data": {"labels": [f"Sc.{i+1}" for i in range(len(l_vals))], "values": l_vals, "ylabel": "Maximum Plume Length L_max [m]", "title": "Scenario Comparison — Ham et al."},
            })
